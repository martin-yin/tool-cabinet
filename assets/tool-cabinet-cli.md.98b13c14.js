import{_ as n,c as s,o as a,b as t}from"./app.ba698385.js";const m='{"title":"tool-cabinet-cli","description":"","frontmatter":{},"headers":[{"level":2,"title":"generate-request-code","slug":"generate-request-code"},{"level":2,"title":"tsyringe-inject","slug":"tsyringe-inject"}],"relativePath":"tool-cabinet-cli.md","lastUpdated":1657818955000}',p={},o=t(`<h1 id="tool-cabinet-cli" tabindex="-1">tool-cabinet-cli <a class="header-anchor" href="#tool-cabinet-cli" aria-hidden="true">#</a></h1><div class="language-typescript"><pre><code>$ pnpm add <span class="token decorator"><span class="token at operator">@</span><span class="token function">martin</span></span><span class="token operator">-</span>yin<span class="token operator">/</span>tool<span class="token operator">-</span>cabinet<span class="token operator">-</span>cli <span class="token operator">-</span>g
...
</code></pre></div><h2 id="generate-request-code" tabindex="-1">generate-request-code <a class="header-anchor" href="#generate-request-code" aria-hidden="true">#</a></h2><p>\u53EF\u81EA\u52A8\u521B\u5EFA\u6574\u6D01\u67B6\u6784\u6240\u9700\u8981\u7684 domain \u6587\u4EF6\u3002</p><p>\u914D\u7F6E\u6587\u4EF6</p><div class="language-typescript"><pre><code><span class="token comment">// generate-request-code.config.ts</span>
...
<span class="token comment">// \u4F7F\u7528 \`defineTsyringeInjectConfig\`, \u6709\u7C7B\u578B\u63D0\u793A\u3002</span>
...
</code></pre></div>`,13),e=[o];function c(l,r,i,u,k,d){return a(),s("div",null,e)}var _=n(p,[["render",c]]);export{m as __pageData,_ as default};
