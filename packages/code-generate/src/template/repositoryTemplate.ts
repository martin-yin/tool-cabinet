import { RepositorySourceCodeType } from '../interface/sourceCode'

export const repositoryTemplate = ({ className, abstractClassName, funcList }: RepositorySourceCodeType) => {
  return `
