...
import { AutoInjiectOption, ImportClasseType, InjectClasseType, InjectSourceFileMapType } from './interface'
import { ReferencedClasse } from './referencedClasse'
import { getDefaultImport, getNamedImportList } from './utils'

export class TsyringeAutoInject {
  ...
  constructor(options: AutoInjiectOption) {
